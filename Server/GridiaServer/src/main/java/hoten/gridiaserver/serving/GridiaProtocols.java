...
public class GridiaProtocols extends Protocols {
    ...
    public enum Clientbound {
        ...
        AddCreature, MoveCreature, RemoveCreature, SectorData, Chat, SetFocus, Initialize, TileUpdate, Container, ContainerUpdate, ItemUsePick, Animation

    }

    public enum Serverbound {

        PlayerMove, SectorRequest, CreatureRequest, MoveItem, Chat, UseItem, PickItemUse, EquipItem, UnequipItem
    }
