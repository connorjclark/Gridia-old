...
set WIN64_PATH="build\%BUILDNAME%\win64\client.exe"
...
set WIN64=-buildWindows64Player %WIN64_PATH%
...
echo "%PROGRAMFILES%\Unity\Editor\Unity.exe" %BATCH% %QUIT% %PROJECT% %PROJECT_PATH% %WIN64%
"%ProgramFiles(x86)%\Unity\Editor\Unity.exe" %BATCH% %QUIT% %PROJECT% %PROJECT_PATH% %WIN64%
